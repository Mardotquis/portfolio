...
const ProjectsCard = (props) => {
    const { projectName, projectDescription, projectImgPath, githubLink, websiteLink } = props;
            ...
            <div className="project_card_information">
                ...
                <div className="project__icons">
                    <div className="project__icons-wrapper">
                        <a href={`${githubLink}`} className="github__icon" target="_blank" rel="noopener"></a>
                        <p className="project__icon-text">Visit GitHub </p>
                    </div>
                    <div className="project__icons-wrapper">
                        <a href={`${websiteLink}`} className="website__icon" target="_blank" rel="noopener"></a>
